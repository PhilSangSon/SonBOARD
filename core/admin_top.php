...
if($nowpage!="login" && $nowpage!="memberController"){
	if($user_id=="" || $user_level<9){
		PageAlert("관리자 아이디로 로그인해주세요.", "view/admin/member", "login");
	}
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?=$_cfg['skin_path']?>css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<?=$_cfg['skin_path']?>css/plugins/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?=$_cfg['skin_path']?>font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./admin_index.php"><?=$_cfg['projectName']?></a>
            </div>
            <!-- Top Menu Items -->
