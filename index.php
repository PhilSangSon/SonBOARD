...
require_once './WebLog/sys_check.php';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <!--[if lt IE 9]><script src="./skin/bootstrap/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="./skin/bootstrap/js/ie-emulation-modes-warning.js"></script>
    ...
    <link href="./skin/bootstrap/css/carousel.css" rel="stylesheet">
  </head>
<!-- NAVBAR
================================================== -->
  <body>
    ...
    <script src="./skin/bootstrap/js/holder.js"></script>
